        ...
        <TailwindProvider>
            ...
            <View className="flex-1 justify-center items-center bg-[#040012] font-bold h-[100%]">
              ...
              <View className="mt-10 flex space-y-4 mb-20">
                <View>
                  <Text className="font-bold mt-10 text-[#8842b3]">SEMISH STAFF CLOCKING APP</Text>
                </View>
              ...
              <View className="font-bold items-center">
                  <Text className="font-bold items-center mb-5 text-[#8842b3]">LOGIN TO YOUR ACCOUNT</Text>
                </View>
              <View className=" flex-1 w-[90%] ">
                ...
                <View className="mb-10">
                  <TextInput
                    ...
                    className=" h-20 rounded border border-indigo-500/50"
                  ></TextInput>
                </View>
                <View className="">
                  <TextInput
